...
const watchedVideoSchema = new mongoose.Schema({
  ...
  videoName:       { type: String, default: '' },      // video ka naam
...
const progressSchema = new mongoose.Schema({
  ...
  userEmail:        { type: String, default: '' },         // user ki email
  courseName:       { type: String, default: '' },         // course ka naam
  currentVideoName: { type: String, default: '' },         // abhi jo video chal rahi hai
